...
var (
	...
	avaxURL      = "https://api.avax-test.network/ext/bc/C/rpc"
	avaxCChainID = big.NewInt(43113)
	avavCtx      context.Context
)
...
func init() {
	...
	// TODO: for Avax, we use Goerli config except for chainID; is it correct for other params?
	chainConfig.ChainID = avaxCChainID
	avavCtx = context.Background()
}
