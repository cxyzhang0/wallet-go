...
func SelectCoins(msgTx *wire.MsgTx, req *TxReq) (int64, int, error) {
	...
	amountSelected, feeAmount, err := SelectInputs(msgTx, utxos, 0, req)
	if err != nil {
		return -1, -1, err
	}
...
func SelectInputs(msgTx *wire.MsgTx, utxos gobcy.Addr, amountSelected int64, req *TxReq) (int64, int, error) {
	var feeAmount int
