...
func BuildTx(req TxReq, sdk *gcpsdk.SDK, chainConfig *params.ChainConfig) (string, string, error) { // signed raw tx, tx hash, error
	...
	signature, err := sdk.Sign(req.From, txHash.Bytes())
	if err != nil {
		return "", "", err
	}
